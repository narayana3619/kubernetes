...
## Deployment
In order to deploy metrics-server in your kubernetes master machine clone https://github.com/narayana3619/kubernetes.git and run the following command from
